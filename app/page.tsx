...
export default function HomePage() {
  return (
    <>
      ...
      <section className="container-responsive py-20" id="tracks">
        <h2 className="text-3xl font-bold">Our Four Tracks</h2>
        <p className="mt-3 max-w-prose text-charcoal/70">Choose your path and master in-demand skills with expert guidance.</p>
        <div className="mt-10 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          <StatCard title="Software Development" value="Full Stack">Build web & mobile apps from frontend to backend.</StatCard>
          <StatCard title="UI/UX Design" value="User-Centered">Design beautiful, intuitive digital experiences.</StatCard>
          <StatCard title="Data Analytics" value="Insights-Driven">Transform data into actionable business insights.</StatCard>
          <StatCard title="Digital Marketing" value="Growth-Focused">Master digital channels & growth strategies.</StatCard>
        </div>
      </section>
      
      <section className="bg-white py-20" id="differentiators">
      ...
      <section className="bg-white py-20" id="partners">
        <div className="container-responsive">
          <h2 className="text-3xl font-bold">Partners & Collaborators</h2>
